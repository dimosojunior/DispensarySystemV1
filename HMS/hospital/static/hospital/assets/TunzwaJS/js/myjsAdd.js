$(document).ready(function(){
    $('#div_id_line_six, #div_id_line_seven, #div_id_line_eight, #div_id_line_nine,#div_id_line_ten').hide()
    $('#more-line').click(function(){
        $('#div_id_line_six').slideToggle(200)
        $('#div_id_line_seven').slideToggle(200)
       
        $('#div_id_line_eight').slideToggle(200)
        $('#div_id_line_nine').slideToggle(200)


        $('#div_id_line_ten').slideToggle(200)
